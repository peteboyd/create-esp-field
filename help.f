...
c*********************************************************************
      ...
      if(atmname(1:1)//' '.eq.atmname)then
        write(outfile,"('*pseudo_extlib/',a1,a24)")atmname(1:1),pseudo
      elseif(' '//atmname(2:2).eq.atmname)then
        write(outfile,"('*pseudo_extlib/',a1,a24)")atmname(2:2),pseudo
      else
        write(outfile,"('*pseudo_extlib/',a2,a24)")atmname,pseudo
      endif
      return
